...
const AnimeImport = () => {
  ...
  // Manejar búsqueda en API externa
  ...
  // Manejar importación de anime seleccionado
  const handleImport = async (externalId) => {
    ...
    try {
      ...
      // Navegar al detalle del anime importado
            ...
            <form onSubmit={handleSearch} className="flex gap-2">
              <div className="flex-grow relative">
                ...
                <input
                  ...
                  className="pl-10 pr-4 py-3 w-full bg-gray-700 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-purple-500"
                />
              </div>
              <button
                type="submit"
                ...
                {isSearching ? (
                  ...
                  <div className="space-y-3 max-h-[600px] overflow-y-auto pr-2">
                    {searchResults.map((anime) => (
                      ...
                      >
                        <div className="w-16 h-20 flex-shrink-0 bg-gray-700 rounded overflow-hidden">
                          <img 
                            src={anime.imageUrl} 
                            alt={anime.title}
                  ...
                  <div className="flex flex-col md:flex-row gap-6">
                    ...
                    <div className="flex-grow">
                      ...
                      <div className="flex flex-wrap gap-2 mb-4">
                        ...
                        <span className="px-2 py-1 bg-gray-700/60 text-gray-200 rounded-full text-xs">
                      ...
                      <div className="mt-4 bg-green-900/20 border border-green-800/30 rounded-lg p-4">
                        <h3 className="text-sm font-semibold text-green-400 mb-2">ID Externo</h3>
                        <div className="bg-gray-800 px-3 py-2 rounded text-xs font-mono text-gray-300 break-all">
