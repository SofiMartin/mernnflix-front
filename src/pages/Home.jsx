...
const Home = () => {
    ...
    return (
      <div className="relative h-screen flex items-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          ...
          ></div>
          <div className="absolute inset-0 bg-gradient-to-t from-gray-900 via-gray-900/40 to-gray-900/80"></div>
        </div>
          ...
          <div className={`max-w-3xl transition-all duration-1000 ${isAnimating ? 'opacity-0 translate-x-10' : 'opacity-100 translate-x-0'}`}>
            ...
            <div className="flex flex-wrap gap-2 mb-4">
              {currentAnime?.genres && currentAnime.genres.slice(0, 4).map((genre, index) => (
                <span 
                  key={index} 
                  className="text-xs px-3 py-1 bg-purple-900/80 text-purple-200 rounded-full"
                >
                  {genre}
                </span>
              ))}
              ...
              {currentAnime && (
                <span className="text-xs px-3 py-1 bg-yellow-600/80 text-yellow-100 rounded-full flex items-center">
            ...
            <p className="text-xl md:text-2xl text-gray-300 mb-8 line-clamp-3">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              {currentAnime && (
                <Link 
                  ...
                  className="px-8 py-3 rounded-full bg-gradient-to-r from-purple-600 to-pink-600 text-white font-medium hover:shadow-lg hover:shadow-purple-500/20 transform hover:-translate-y-1 transition-all duration-300 flex items-center"
                >
              ...
              {!isAuthenticated ? (
                ...
                <Link 
                  to="/watchlist" 
                  className="px-8 py-3 rounded-full bg-transparent border-2 border-purple-500 text-white font-medium hover:bg-purple-900/30 transform hover:-translate-y-1 transition-all duration-300 flex items-center"
                >
  ...
  const AnimeGridCard = ({ anime, index }) => (
    ...
    >
      <div className="aspect-[3/4] bg-gray-800 relative">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-4">
          <h3 className="text-white font-bold mb-1 truncate group-hover:text-purple-300 transition-colors">{anime.title}</h3>
    ...
    return (
      <div className="min-h-screen bg-gray-900 flex items-center justify-center">
        <div className="relative">
          ...
          <div className="w-16 h-16 border-4 border-pink-500 border-b-transparent rounded-full animate-spin absolute top-0 left-0" style={{ animationDirection: 'reverse', animationDuration: '1.5s' }}></div>
        </div>
        <p className="text-purple-300 ml-4 text-lg">Cargando tu experiencia anime...</p>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white overflow-hidden">
      ...
      <div className="py-8 bg-gradient-to-b from-gray-900 to-gray-800 relative">
        <div className="container mx-auto px-4">
          <div className="rounded-xl overflow-hidden relative shadow-2xl">
            <div className="absolute inset-0 bg-gradient-to-r from-purple-900/80 via-pink-900/40 to-transparent z-10"></div>
            <img 
      ...
      <div 
        ...
        className="py-16 bg-gray-900 relative opacity-0 transition-opacity duration-1000"
      >
        <div className="absolute top-0 left-0 right-0 h-24 bg-gradient-to-b from-gray-800 to-transparent z-10"></div>
        <div className="container mx-auto px-4">
      ...
      <div 
        ...
        className="py-16 bg-gradient-to-b from-gray-900 to-gray-900/90 opacity-0 transition-opacity duration-1000"
      >
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center mb-8">
            <h2 className="text-3xl font-bold flex items-center">
      ...
      <div 
        ...
        className="py-16 bg-gradient-to-b from-gray-900/90 to-gray-900 opacity-0 transition-opacity duration-1000"
      >
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-center mb-8">
            <h2 className="text-3xl font-bold flex items-center">
              <span className="w-1 h-8 bg-pink-500 mr-3"></span>
              <span className="bg-gradient-to-r from-purple-400 to-pink-500 text-transparent bg-clip-text">
                Nuevos Lanzamientos
              </span>
            </h2>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-7 gap-4 mb-8">
            {['Lunes', 'Martes', 'Miércoles', 'Jueves', 'Viernes', 'Sábado', 'Domingo'].map((day, index) => (
              <div key={index} className="p-4 bg-gray-800/50 rounded-lg backdrop-blur-sm hover:bg-gray-800 transition-colors">
                <h3 className="text-lg font-bold text-center mb-3 text-purple-300">{day}</h3>
                <div className="space-y-3">
                  {(index === 0 || index === 5 || index === 6) && trendingAnimes.length > 0 ? (
                    trendingAnimes.slice(0, 2).map((anime, animeIndex) => (
                      <Link key={animeIndex} to={`/animes/${anime.id}`} className="flex items-center p-2 hover:bg-gray-700/50 rounded transition-colors">
                        <img 
                          src={anime.imageUrl} 
                          alt={anime.title} 
          ...
          <div className="text-center">
            <Link 
              to="/schedule" 
              className="inline-flex items-center px-6 py-3 rounded-full bg-purple-900/50 hover:bg-purple-900/80 text-white transition-colors"
            >
      ...
      <div className="py-20 bg-gradient-to-r from-purple-900/30 via-pink-900/30 to-purple-900/30 relative overflow-hidden">
        {/* Animated background elements */}
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute -top-20 -left-20 w-64 h-64 bg-purple-500/10 rounded-full blur-3xl animate-blob"></div>
          <div className="absolute top-40 -right-20 w-80 h-80 bg-pink-500/10 rounded-full blur-3xl animate-blob" style={{ animationDelay: '2s', animationDuration: '8s' }}></div>
          <div className="absolute bottom-10 left-1/4 w-72 h-72 bg-blue-500/10 rounded-full blur-3xl animate-blob" style={{ animationDelay: '4s', animationDuration: '12s' }}></div>
        </div>
        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          ...
          {!isAuthenticated ? (
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              ...
              <Link 
                to="/register" 
                className="px-8 py-3 rounded-full bg-white text-purple-900 font-bold hover:bg-purple-100 transition-all hover:shadow-lg hover:shadow-white/20 transform hover:-translate-y-1"
              >
                Crear Cuenta Gratis
              </Link>
            </div>
        ...
        <div className="py-16 bg-gray-900">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {/* Feature 1 */}
              <div className="p-6 rounded-xl bg-gray-800/50 backdrop-blur-sm border border-gray-700 text-center hover:bg-gray-800 transition-colors transform hover:-translate-y-2 duration-300 hover:shadow-xl hover:shadow-purple-500/5">
                ...
                <h3 className="text-xl font-bold mb-3 text-purple-300">Colección Completa</h3>
                ...
                <Link to="/animes" className="inline-flex items-center text-purple-400 hover:text-purple-300">
                  Explorar catálogo
              ...
              <div className="p-6 rounded-xl bg-gray-800/50 backdrop-blur-sm border border-gray-700 text-center hover:bg-gray-800 transition-colors transform hover:-translate-y-2 duration-300 hover:shadow-xl hover:shadow-purple-500/5">
                ...
                <h3 className="text-xl font-bold mb-3 text-purple-300">Perfiles Personalizados</h3>
                ...
                <Link to="/register" className="inline-flex items-center text-purple-400 hover:text-purple-300">
                  Crear perfil
                  <svg className="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path>
                  </svg>
              ...
              <div className="p-6 rounded-xl bg-gray-800/50 backdrop-blur-sm border border-gray-700 text-center hover:bg-gray-800 transition-colors transform hover:-translate-y-2 duration-300 hover:shadow-xl hover:shadow-purple-500/5">
                ...
                <h3 className="text-xl font-bold mb-3 text-purple-300">Listas Personalizadas</h3>
          ...
          <div className="flex flex-col lg:flex-row items-center gap-8">
            <div className="lg:w-1/2">
              ...
              <div className="flex flex-wrap gap-4 mb-8">
                <a href="#" className="block p-1 bg-gradient-to-r from-purple-500 to-pink-500 rounded-xl hover:from-purple-600 hover:to-pink-600 transition-all transform hover:-translate-y-1 duration-300">
                  <div className="bg-gray-900 px-5 py-2 rounded-lg flex items-center space-x-2">
              ...
              <div className="flex items-center space-x-4">
                <div className="flex -space-x-2">
                  <img src="https://randomuser.me/api/portraits/women/79.jpg" className="w-10 h-10 rounded-full border-2 border-gray-800" alt="User" />
                  <img src="https://randomuser.me/api/portraits/men/32.jpg" className="w-10 h-10 rounded-full border-2 border-gray-800" alt="User" />
                  <img src="https://randomuser.me/api/portraits/women/42.jpg" className="w-10 h-10 rounded-full border-2 border-gray-800" alt="User" />
                </div>
            ...
            <div className="lg:w-1/2 relative">
              <div className="relative z-10 transform rotate-2 hover:rotate-0 transition-transform duration-500">
                <div className="absolute -inset-0.5 bg-gradient-to-r from-purple-500 to-pink-500 rounded-2xl blur"></div>
                <img 
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div 
                key={index} 
                className="p-6 rounded-xl bg-gray-800 border border-gray-700 shadow-lg hover:shadow-purple-500/5 transition-shadow"
              >
      ...
      <div className="py-16 bg-gradient-to-r from-purple-900/20 via-pink-900/20 to-purple-900/20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <form className="flex flex-col sm:flex-row gap-3 mx-auto max-w-xl">
              ...
              <button 
                type="submit" 
                className="px-6 py-3 rounded-lg bg-gradient-to-r from-purple-600 to-pink-600 text-white font-medium hover:from-purple-700 hover:to-pink-700 transition-all"
              >
                Suscribirme
              </button>
            </form>
