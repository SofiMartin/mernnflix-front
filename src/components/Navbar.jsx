          ...
          <div className="hidden md:flex items-center ml-4">
            {currentUser && currentProfile ? (
              ...
              <div className="flex items-center space-x-4">
                <Link
                  to="/login"
                  className="px-6 py-2 rounded-full border border-purple-500 text-purple-400 hover:bg-purple-900/20 hover:text-white text-sm font-medium transition-all duration-300"
                >
                  Iniciar sesión
                </Link>
                <Link
                  to="/register"
                  className="px-6 py-2 rounded-full bg-gradient-to-r from-purple-600 to-pink-600 text-white text-sm font-medium hover:shadow-lg hover:from-purple-700 hover:to-pink-700 transition-all duration-300"
                >
                  Registrarse
                </Link>
              </div>
        ...
        <div className="container mx-auto px-4 py-2 space-y-2">
          ...
          {currentUser && currentProfile ? (
            ...
            <div className="flex flex-col space-y-2 border-b border-gray-700 pb-4 mb-2">
              ...
              <Link
                to="/register"
                className="w-full px-4 py-3 text-center bg-purple-600 hover:bg-purple-700 text-white rounded-lg transition-colors"
                onClick={closeMenu}
              >
                Registrarse
              </Link>
